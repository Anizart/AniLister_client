      ...
      <div className="container">
        <div className="filter">
          <div className="filter__wrapper">
            <button type="button" class="filter-tag" data-filter="all">
              Всего прочитано: 3
            </button>
            <button type="button" class="filter-tag" data-filter="liked">
              Понравилось: 1
            </button>
            <button type="button" class="filter-tag" data-filter="favorites">
              Любимые: 1
            </button>
            <button type="button" class="filter-tag" data-filter="to-read">
              Стоит перечитать: 1
            </button>
          </div>
          <button
