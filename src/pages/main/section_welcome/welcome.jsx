...
const Welcome = ({ onOpenAuthentication }) => {
  ...
  return (
    <section className='section section-welcome'>
      <div className='container'>
        ...
        <div className='offer'>
          <h1 className='title offer__title'>
            Список. Прогресс. Память.
          </h1>
          <div className='text offer__text'>
            ...
            <br /> Что забросил? ... <br /> Теперь всё это
            можно отметить, найти и вспомнить — в одном
            месте.
