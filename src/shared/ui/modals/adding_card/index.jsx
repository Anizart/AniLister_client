...
const AddingCard = ({
  ...
  const MarkIcon = ({ type }) => {
    const color = mode
      ? 'var(--dark-main-text)'
      : 'var(--light-main-text)'
    const activeColor = 'var(--accent-text)'
      ...
      case 'reread':
        return (
          ...
          >
            ...
            />
            <path
              d='M4.21582 24.3322C4.21582 24.3322 9.84052 14.7234 19.6837 14.7234C29.5269 14.7234 35.1516 24.3322 35.1516 24.3322C35.1516 24.3322 29.5269 33.941 19.6837 33.941C9.84052 33.941 4.21582 24.3322 4.21582 24.3322Z'
              stroke={fill}
            />
            <path
              d='M19.6838 27.9355C22.0136 27.9355 23.9023 26.3222 23.9023 24.3322C23.9023 22.3421 22.0136 20.7289 19.6838 20.7289C17.354 20.7289 15.4653 22.3421 15.4653 24.3322C15.4653 26.3222 17.354 27.9355 19.6838 27.9355Z'
              fill={fill}
            />
          </svg>
        )
